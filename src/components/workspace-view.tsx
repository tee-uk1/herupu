...
import { LayoutGrid, List, Command } from "lucide-react"
...
export function WorkspaceView({
  ...
  // Flatten tasks for palette search
  const allTasks = useMemo(() => {
    return initialColumns.flatMap((col) => col.tasks)
  }, [initialColumns])

  // Filter columns and nested tasks reactively
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* Top Bar: View Switcher & Palette Trigger */}
      ...
      {/* Slide-over Drawer for List View & Palette jumps */}
      <TaskDetailDrawer
        task={selectedTask}
